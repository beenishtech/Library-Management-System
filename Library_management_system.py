{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyPQZun6l4eQFY2UYUXAAHGs",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/beenishtech/Library-Management-System/blob/main/Library_management_system.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "i7CNhJFt86bD",
        "outputId": "a78e8413-7f1b-4cf8-9872-7dc21740db5d"
      },
      "execution_count": 7,
      "outputs": [
        {
          ...
          "text": [
            ...
            "--- Add / Update Book ---\n",
            "Enter Book ID: #06\n",
            "Enter Book Name: world ends\n",
            "Enter Author: Zohan\n",
            "Enter Quantity Available: 60\n",
            "Book 'world ends' added successfully!\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "--- Add / Update Book ---\n",
            "Enter Book ID: #07\n",
            "Enter Book Name: History of world \n",
            "Enter Author: Fabi\n",
            "Enter Quantity Available: 100\n",
            "Book 'History of world' added successfully!\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "--- Add / Update Book ---\n",
            "Enter Book ID: #08\n",
            "Enter Book Name: software\n",
            "Enter Author: Hiba\n",
            "Enter Quantity Available: 100\n",
            "Book 'software' added successfully!\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "Enter Book ID to issue: #05\n",
            "How many copies do you want? (Available in stock: 100): 3\n",
            "[Success] 3 copies of 'Love nature' issued to ali!\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "\n",
            "--- Issue a Book ---\n",
            "Enter Student Name: umaizah\n",
            "Enter Book ID to issue: #06\n",
            "How many copies do you want? (Available in stock: 60): 1\n",
            "[Success] 1 copies of 'world ends' issued to umaizah!\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "How many copies do you want? (Available in stock: 100): 5\n",
            "[Success] 5 copies of 'Hope' issued to shah!\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "\n",
            "--- Issue a Book ---\n",
            "Enter Student Name: vaynisa\n",
            "Enter Book ID to issue: #03\n",
            "How many copies do you want? (Available in stock: 100): 2\n",
            "[Success] 2 copies of 'Medical practice' issued to vaynisa!\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "Enter Book ID to issue: #06\n",
            "How many copies do you want? (Available in stock: 59): 10\n",
            "[Success] 10 copies of 'world ends' issued to annie!\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "\n",
            "--- Issue a Book ---\n",
            "Enter Student Name: zoya\n",
            "Enter Book ID to issue: #08\n",
            "How many copies do you want? (Available in stock: 100): 40\n",
            "[Success] 40 copies of 'software' issued to zoya!\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "--- Return a Book ---\n",
            "Enter Student Name: zoya\n",
            "Enter Book ID to return: #08\n",
            "\n",
            "[System] Found Record: This student has issued 40 copies of this book.\n",
            "How many copies are you returning now?: 20\n",
            "[History] Return record successfully added to returns.csv!\n",
            "[Success] 20 copy returned. Remaining 20 copies are STILL issued to zoya.\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "\n",
            "[System] Found Record: This student has issued 5 copies of this book.\n",
            "How many copies are you returning now?: 2\n",
            "[History] Return record successfully added to returns.csv!\n",
            "[Success] 2 copy returned. Remaining 3 copies are STILL issued to shah.\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "--- Return a Book ---\n",
            "Enter Student Name: annie\n",
            "Enter Book ID to return: #06\n",
            "\n",
            "[System] Found Record: This student has issued 10 copies of this book.\n",
            "How many copies are you returning now?: 3\n",
            "[History] Return record successfully added to returns.csv!\n",
            "[Success] 3 copy returned. Remaining 7 copies are STILL issued to annie.\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "--- Return a Book ---\n",
            "Enter Student Name: ali\n",
            "Enter Book ID to return: #05\n",
            "\n",
            "[System] Found Record: This student has issued 3 copies of this book.\n",
            "How many copies are you returning now?: 2\n",
            "[History] Return record successfully added to returns.csv!\n",
            "[Success] 2 copy returned. Remaining 1 copies are STILL issued to ali.\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "Enter Book ID to return: #08\n",
            "\n",
            "[System] Found Record: This student has issued 20 copies of this book.\n",
            "How many copies are you returning now?: 4\n",
            "[History] Return record successfully added to returns.csv!\n",
            "[Success] 4 copy returned. Remaining 16 copies are STILL issued to zoya.\n",
            "[Auto-Save] Data successfully saved to CSV files!\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "2. Search by Author\n",
            "Choose search criteria (1-2): 1\n",
            "Enter your search keyword: Hope\n",
            "\n",
            "Search Results:\n",
            ...
            "\n",
            "=====LIBRARY REPORT=====\n",
            "Total Unique Titles Stored: 8\n",
            "Total Physical Books Currently Available: 581\n",
            "Total Books Currently Issued Out      : 30\n",
            "================================\n",
            "\n",
            "===== LIBRARY MANAGEMENT SYSTEM =====\n",
            "1. Add/Update Books\n",
            ...
            "\n",
            "Exiting program. All data is already saved. Goodbye!\n"
          ]
        }
      ]
    }
